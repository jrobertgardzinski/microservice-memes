 ...
 * Resolution order: the leaver's wizard choice carried with the saga command, then the admin's
 * runtime {@link PurgePolicyOverride}, then the deployment default. A meme
